...
const char *show_date(size_t time, int timezone, const struct date_mode *mode);
void show_date_relative(size_t time, int tz, const struct timeval *now,
...
size_t approxidate_careful(const char *, int *);
size_t approxidate_relative(const char *date, const struct timeval *now);
void parse_date_format(const char *format, struct date_mode *mode);
int date_overflows(size_t date);
