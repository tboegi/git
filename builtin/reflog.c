...
static size_t default_reflog_expire;
static size_t default_reflog_expire_unreachable;

struct cmd_reflog_expire_cb {
	struct rev_info revs;
	int stalefix;
	size_t expire_total;
	size_t expire_unreachable;
	int recno;
};
...
static void mark_reachable(struct expire_reflog_policy_cb *cb)
{
	...
	size_t expire_limit = cb->mark_limit;
...
static int parse_expire_cfg_value(const char *var, const char *value, size_t *expire)
{
	if (!value)
